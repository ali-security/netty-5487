...
public abstract class HttpObjectDecoder extends ByteToMessageDecoder {
    ...
    public static final String PROP_DEFAULT_STRICT_LINE_PARSING = "io.netty.handler.codec.http.defaultStrictLineParsing";
    public static final boolean DEFAULT_STRICT_LINE_PARSING = 
            SystemPropertyUtil.getBoolean(PROP_DEFAULT_STRICT_LINE_PARSING, true);
